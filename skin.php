...
show_header( $post['title'], FALSE, '', '', 'MCPEHub is the #1 Minecraft PE community in the world, featuring seeds, maps, servers, mods, and more.', 'minecraft pe skins, skins, minecraft pe, mcpe' );
...
<?php } ?>
    ...
    <div class="actions more"><a href="http://mcpehub.com/<?php echo $type.'s'; ?>"><i class="fa fa-smile-o fa-fw"></i>Minecraft PE <?php echo ucwords( $type ).'s'; ?></a></div>
