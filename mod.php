...
show_header( $post['title'], FALSE, '', '', 'MCPEHub is the #1 Minecraft PE community in the world, featuring seeds, maps, servers, mods, and more.', 'minecraft pe mods, minecraft pe, mcpe' );
...
<?php } ?>
    ...
    <div class="details clearfix">
        ...
        <div class="section last">
            ...
            <div class="actions">
                <a href="/how-to-install-mods" target="_blank"><i class="fa fa-question fa-fw"></i> How To Install</a>
            </div>
        </div>
    </div>
    ...
    <div class="actions more"><a href="http://mcpehub.com/<?php echo $type.'s'; ?>"><i class="fa fa-codepen fa-fw"></i>Minecraft PE <?php echo ucwords( $type ).'s'; ?></a></div>
