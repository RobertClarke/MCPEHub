...
<div id="how-to" class="tleft">
    ...
    <br>
    <b>IMPORTANT: Make sure you have your device plugged in, and be sure to back up your maps, mods, etc. since it will return your Minecraft PE app to new since it was deleted and re-downloaded onto the device.</b>
    ...
    <h2><i class="fa fa-android fa-fw"></i> Android Unrooted Install</h2>
    <ol class="spaced">
        <li>
            Software you will need:<br />
            - Block Launcher<br />
