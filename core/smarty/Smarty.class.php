...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     */
    public static $_muted_directories = array('./core/templates_c/' => null, './core/templates_cache/' => null);
     ...
     * @var array
     */
    private $template_dir = array('./core/templates/');
     ...
     * @var string
     */
    public $joined_template_dir = './core/templates/';
     ...
     * @var string
     */
    private $compile_dir = './core/templates_c/';
     ...
     * @var string
     */
    private $cache_dir = './core/templates_cache/';
    ...
    public function __construct()
    {
        ...
        if ($this->template_dir[0] !== './core/templates/' || isset($this->template_dir[1])) {
        ...
        if ($this->compile_dir !== './core/templates_c/') {
            unset(self::$_muted_directories['./core/templates_c/']);
            $this->setCompileDir($this->compile_dir);
        }
        if ($this->cache_dir !== './core/templates_cache/') {
            unset(self::$_muted_directories['./core/templates_cache/']);
