...
show_header( 'Moderate Posts', TRUE, '', 'dash' );
...
echo '<div class="post">
    <div class="img">
        ...
        <a href="/'.$post['type'].'/'.$post['slug'].'"><img src="'.$post['image_url'].'" alt="'.$post['title'].'" width="700" height="50"></a>
    </div>
    <div class="info">
        <ul>
            <li class="solo"><i class="fa fa-male"></i> <a href="/user/'.$post['author'].'">'.$post['author'].'</a></li>
        </ul>
        <div class="link">
            ...
            <a href="/moderate" style="float: left;" class="bttn dl silver red right reject tip" data-tip="Reject"><i class="fa fa-times no-space"></i></a>
            <a href="/moderate" style="float: left;" class="bttn dl silver right del tip" data-tip="Delete"><i class="fa fa-trash-o no-space"></i></a>
             <a href="/'.$post['type'].'/'.$post['slug'].'" style="display:inline-block;" class="button dl silver"><i class="fa fa-eye"></i></a>
        </div>
    </div>
    
    <div class="delconf">
            <span>Are you sure you want to delete this '.$post['type'].'?</span>
            <a href="'.$url->show('action=delete&post='.$post['id'].'&type='.$post['type']).'" class="bttn red">Confirm Delete</a>
        </div>
        <div class="rejconf">
            <span>Are you sure you want to reject this '.$post['type'].'?</span>
            <a href="'.$url->show('action=reject&post='.$post['id'].'&type='.$post['type']).'" class="bttn red">Reject Submission</a>
        </div>
