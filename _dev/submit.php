...
<form action="<?php echo $url->show('type='.$post_type); ?>" method="POST" class="form submission" enctype="multipart/form-data">
...
<?php } ?>
    ...
    <div class="buttons-cont">
        <button type="submit" id="submit" class="bttn green large"><i class="fa fa-upload"></i> Submit <?php echo ucwords($post_type); ?></button>
    </div>
