tinymce.PluginManager.add('smileys', function (editor, url) {
    var defaultSmileys = [
                        [
                        	{ shortcut: ':)', url: url + '/img/Smile.png', title: '' },
                        	{ shortcut: ':(', url: url + '/img/Frown.png', title: '' },
                        	{ shortcut: ':|', url: url + '/img/Slant.png', title: '' },
                        	{ shortcut: ';)', url: url + '/img/Wink.png', title: '' },
                        	{ shortcut: ':D', url: url + '/img/Grin.png', title: '' },   
                        	{ shortcut: ':S', url: url + '/img/Confused.png', title: '' },
                        	{ shortcut: ':P', url: url + '/img/Crazy.png', title: '' }
                        ],
                        [
                        	{ shortcut: ':o', url: url + '/img/Gasp.png', title: '' },
                        	{ shortcut: '8)', url: url + '/img/Cool.png', title: '' },
                        	{ shortcut: '>=(', url: url + '/img/Angry.png', title: '' },
                        	{ shortcut: '>_>', url: url + '/img/Not-Amused.png', title: '' },
                        	{ shortcut: '(y)', url: url + '/img/Thumbs-Up.png', title: '' },
                        	{ shortcut: '(n)', url: url + '/img/Thumbs-Down.png', title: '' },
                        	{ shortcut: '<3', url: url + '/img/Heart.png', title: '' }
                        ],
                        [
                        	{ shortcut: '[diamond]', url: url + '/img/diamond.png', title: '' },
                        	{ shortcut: '[diamond pick]', url: url + '/img/diamond_pick.png', title: '' },
                        	{ shortcut: '[coal]', url: url + '/img/coal.png', title: '' },
                        	{ shortcut: '[tnt]', url: url + '/img/tnt.png', title: '' },
                        	{ shortcut: '[cake]', url: url + '/img/cake.png', title: '' },
                        	{ shortcut: '[cookie]', url: url + '/img/cookie.png', title: '' },
                        	{ shortcut: '[apple]', url: url + '/img/apple.png', title: '' }
                        ]
    ];
