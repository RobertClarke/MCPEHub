...
<form action="/edit_profile" method="POST" class="form submission">
    ...
    <div class="inputs clearfix">
        ...
        <div class="input half last"><div class="label"><label for="devices"><i class="fa fa-mobile fa-fw"></i> Play MCPE On</label></div><select name="devices[]" id="devices" class="chosen-select" data-placeholder="Click to select devices" multiple ><option value="iOS"<?php if ( in_array( 'iOS', $form_input['devices'] ) ) echo ' selected'; ?>>iOS</option><option value="Android"<?php if ( in_array( 'Android', $form_input['devices'] ) ) echo ' selected'; ?>>Android</option></select></div>
