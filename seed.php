...
show_header( $post['title'], FALSE, '', '', 'MCPEHub is the #1 Minecraft PE community in the world, featuring seeds, maps, servers, mods, and more.', 'minecraft pe seeds, flat seeds, minecraft pe, mcpe' );
...
<?php } ?>
    ...
    <div class="details clearfix">
        ...
        <div class="section last">
            <a class="view-bttn seed lc"><?php echo ( !empty( $post['seed'] ) ) ? $post['seed'] : 'Check Description For Seed' ; ?></a>
            <ul class="stats">
                <li>
    ...
    <div class="actions more"><a href="http://mcpehub.com/<?php echo $type.'s'; ?>"><i class="fa fa-leaf fa-fw"></i>Minecraft PE <?php echo ucwords( $type ).'s'; ?></a></div>
