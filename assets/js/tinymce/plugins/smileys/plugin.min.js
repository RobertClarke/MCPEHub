tinymce.PluginManager.add('smileys', function (editor, url) {
    var defaultSmileys = [
                        [
                        	{ shortcut: ':)', url: 'Smile.png', title: '' },
                        	{ shortcut: ':(', url: 'Frown.png', title: '' },
                        	{ shortcut: ':|', url: 'Slant.png', title: '' },
                        	{ shortcut: ';)', url: 'Wink.png', title: '' },
                        	{ shortcut: ':D', url: 'Grin.png', title: '' },   
                        	{ shortcut: ':S', url: 'Confused.png', title: '' },
                        	{ shortcut: ':P', url: 'Crazy.png', title: '' }
                        ],
                        [
                        	{ shortcut: ':o', url: 'Gasp.png', title: '' },
                        	{ shortcut: '8)', url: 'Cool.png', title: '' },
                        	{ shortcut: '>=(', url: 'Angry.png', title: '' },
                        	{ shortcut: '>_>', url: 'Not-Amused.png', title: '' },
                        	{ shortcut: '(y)', url: 'Thumbs-Up.png', title: '' },
                        	{ shortcut: '(n)', url: 'Thumbs-Down.png', title: '' },
                        	{ shortcut: '<3', url: 'Heart.png', title: '' }
                        ],
                        [
                        	{ shortcut: '[diamond]', url: 'diamond.png', title: '' },
                        	{ shortcut: '[diamond pick]', url: 'diamond_pick.png', title: '' },
                        	{ shortcut: '[coal]', url: 'coal.png', title: '' },
                        	{ shortcut: '[tnt]', url: 'tnt.png', title: '' },
                        	{ shortcut: '[cake]', url: 'cake.png', title: '' },
                        	{ shortcut: '[cookie]', url: 'cookie.png', title: '' },
                        	{ shortcut: '[apple]', url: 'apple.png', title: '' }
                        ]
    ];
    ...
    function getHtml() {
        ...
        tinymce.each(fullSmileysList, function (row) {
            ...
            tinymce.each(row, function (icon) {
                smileysHtml += '<td><a href="#" data-mce-url="' + icon.url + '" tabindex="-1" title="' + icon.title + '"><img src="/assets/img/smilies/' +
    ...
    editor.addButton('smileys', {
        ...
        panel: {
            ...
            onclick: function (e) {
                ...
                if (linkElm) {
                    editor.insertContent('<img src="/assets/img/smilies/' + linkElm.getAttribute('data-mce-url') + '" />');
                    this.hide();
                }
            }
        },
