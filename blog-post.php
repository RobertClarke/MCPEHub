...
$type = 'blog';
if ( !isset($_GET['post']) || empty($_GET['post']) ) redirect( '/blog' );
...
$pg = [
	...
	'seo_keywords'	=> 'minecraft pe blog, mcpe blog, minecraft blog, minecraft pe, mcpe'
];
...
$p['published']	= ( $p['active'] != 0 ) ? 'Posted '.date( 'd/m/Y', strtotime($p['published']) ) : 'Not Approved Yet';
