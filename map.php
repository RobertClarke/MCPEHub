...
<?php } ?>
    ...
    <div class="details clearfix">
        ...
        <div class="section last">
            ...
            <div class="actions">
                <a href="/how-to-install-maps" target="_blank"><i class="fa fa-question fa-fw"></i> How To Install</a>
            </div>
        </div>
    </div>
    ...
    <div class="actions more"><a href="http://mcpehub.com/<?php echo $type.'s'; ?>"><i class="fa fa-map-marker fa-fw"></i>Minecraft PE <?php echo ucwords( $type ).'s'; ?></a></div>
