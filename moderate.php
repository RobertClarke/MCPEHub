    ...
    <div class="post clearfix">
        ...
        <div class="details">
            ...
            <div class="actions">
                ...
                <span class="info"><span><i class="fa fa-male"></i> <a href="/user/<?php echo $post['author']; ?>"><?php echo $post['author']; ?></a></span><span><i class="fa fa-clock-o"></i> <?php echo time_since( strtotime( $post['submitted'] ) ); ?></span></span>
                
                <a href="<?php echo $c_url->show('action=approve&post='.$post['id'].'&type='.$post['type']); ?>" class="bttn green right tip" data-tip="Approve"><i class="fa fa-check no-space"></i></a>
...
<?php } ?>
        ...
        <div class="rejconf">
            <span>Are you sure you want to reject this <?php echo $post['type']; ?>?</span>
            <a href="<?php echo $c_url->show('action=reject&post='.$post['id'].'&type='.$post['type']); ?>" class="bttn red">Reject Submission</a>
        </div>
    </div>
